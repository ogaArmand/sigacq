"""
Django settings for pisciculture project.
...
SECRET_KEY = 'django-insecure-a4)(%vk*3)et!d#y-0w5=_gtwmky4@a(#isfrx1f1x5m%!q!y9'
...
ROOT_URLCONF = 'pisciculture.urls'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'gestion_pisciculture', 'static'),
]
