...
urlpatterns = [
    ...
    path('modifier_StockAlimentaire', modifier_StockAlimentaire, name='modifier_StockAlimentaire'),
    path('supprimer_StockAlimentaire', views.supprimer_StockAlimentaire, name='supprimer_StockAlimentaire'),
